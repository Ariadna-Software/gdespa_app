...
WHERE iin.storeId = 1 AND iinl.itemId = 226 AND iin.dateIn > '2016-09-30 00:00:00.000' 
...
WHERE iout.storeId = 1 AND ioutl.itemId = 226 AND iout.dateOut > '2016-09-30 00:00:00.000' 
