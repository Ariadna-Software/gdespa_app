...
var woLineAPI = {
    get: function (done, test) {
        dbCon.getConnection(function (err, res) {
            ...
            var sql = "SELECT wol.woLineId, wol.woId, wol.cunitId, cu.name AS cunitName, wol.estimate, wol.done, wol.quantity, wol.planned,";
            ...
            sql += " LEFT JOIN chapter as ch ON ch.chapterId = wol.chapterId"
