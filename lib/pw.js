...
var pwAPI = {
    get: function (done, test) {
        dbCon.getConnection(function (err, res) {
            ...
            sql += " LEFT JOIN (SELECT wo.pwId AS p, SUM(wow.quantity * wow.cost) AS c FROM wo_worker AS wow INNER JOIN wo ON wo.woId = wow.woId GROUP BY wow.woId) AS w ON w.p = p.pwId";
